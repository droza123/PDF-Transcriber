import { Sun, Moon, FileText, Key } from 'lucide-react';
...
export default function Header({ theme, onToggleTheme, hasKey }: HeaderProps) {
  return (
    <header className="flex items-center justify-between px-6 py-4 border-b border-p-border">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-p-text-muted">Batch converter for academic citation</p>
        </div>
      </div>
      <div className="flex items-center gap-3">
